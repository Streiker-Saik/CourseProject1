...
```
- investment_bank
- - принимает дату('YYYY-MM-DD'), список транзакций и лимит
- - возвращает JSON строку, сумму, которую удалось бы отложить в "Инвесткопилку"
```
investment_bank(20, transactions_list, 50)
>>>
'{"invest_savings": xxx}'
```
- simple_search
- - принимает список транзакций и поисковое строку
- - возвращает JSON строку, фильтрованную с наличием строки в категориях или описании
```
simple_search(transactions_list, "Супермаркеты")
>>>
'[
...
- - возвращает JSON строку, фильтрованную с наличием мобильного телефона "+7 ХХХ ХХХ-ХХ-ХХ"
```
search_by_phone(transactions_list)
>>>
'[
...
- - принимает список транзакций 
- - возвращает JSON строку, фильтрованную с наличием фамилии и имени в описании, с категорией "Переводы"
```
search_transfers_to_individuals(transactions_list)
>>>
'[
