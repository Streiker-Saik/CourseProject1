...
- - Приветствие, 
- - О каждой карте(последние 4 цифры карты, общая сумма расходов, кешбэк (1 рубль на каждые 100 рублей))
- - Топ-5 транзакций по сумме платежа.
- - Курс валют.
- - Стоимость акций
- Сервисы: Выгодные категории повышенного кешбэка
- Отчеты: Траты по категории, Траты по дням недели, Траты в рабочий/выходной день
